...
import ru.gpsbox.pond.repository.ChemicalAnalysisRepository;
import ru.gpsbox.pond.repository.search.ChemicalAnalysisSearchRepository;
import ru.gpsbox.pond.service.dto.ChemicalAnalysisDTO;
import ru.gpsbox.pond.service.mapper.ChemicalAnalysisMapper;
...
public class ChemicalAnalysisResourceIntTest {
     ...
     */
    public static ChemicalAnalysis createEntity() {
    ...
    public void initTest() {
        chemicalAnalysisRepository.deleteAll();
        chemicalAnalysisSearchRepository.deleteAll();
        chemicalAnalysis = createEntity();
    }
    ...
    public void createChemicalAnalysisWithExistingId() throws Exception {
        ...
        chemicalAnalysis.setId("existing_id");
        ChemicalAnalysisDTO chemicalAnalysisDTO = chemicalAnalysisMapper.toDto(chemicalAnalysis);
    ...
    public void getAllChemicalAnalyses() throws Exception {
        ...
        chemicalAnalysisRepository.save(chemicalAnalysis);
        ...
        restChemicalAnalysisMockMvc.perform(get("/api/chemical-analyses?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(chemicalAnalysis.getId())))
    ...
    public void getChemicalAnalysis() throws Exception {
        ...
        restChemicalAnalysisMockMvc.perform(get("/api/chemical-analyses/{id}", chemicalAnalysis.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.id").value(chemicalAnalysis.getId()))
    ...
    public void dtoEqualsVerifier() throws Exception {
        ...
        chemicalAnalysisDTO1.setId("id1");
        ...
        chemicalAnalysisDTO2.setId("id2");
        assertThat(chemicalAnalysisDTO1).isNotEqualTo(chemicalAnalysisDTO2);

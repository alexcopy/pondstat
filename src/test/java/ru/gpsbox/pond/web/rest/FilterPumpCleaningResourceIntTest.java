...
import ru.gpsbox.pond.repository.FilterPumpCleaningRepository;
import ru.gpsbox.pond.repository.search.FilterPumpCleaningSearchRepository;
import ru.gpsbox.pond.service.dto.FilterPumpCleaningDTO;
import ru.gpsbox.pond.service.mapper.FilterPumpCleaningMapper;
...
public class FilterPumpCleaningResourceIntTest {
     ...
     */
    public static FilterPumpCleaning createEntity() {
    ...
    public void initTest() {
        filterPumpCleaningRepository.deleteAll();
        filterPumpCleaningSearchRepository.deleteAll();
        filterPumpCleaning = createEntity();
    }
    ...
    public void createFilterPumpCleaningWithExistingId() throws Exception {
        ...
        filterPumpCleaning.setId("existing_id");
        FilterPumpCleaningDTO filterPumpCleaningDTO = filterPumpCleaningMapper.toDto(filterPumpCleaning);
    ...
    public void getAllFilterPumpCleanings() throws Exception {
        ...
        filterPumpCleaningRepository.save(filterPumpCleaning);
        ...
        restFilterPumpCleaningMockMvc.perform(get("/api/filter-pump-cleanings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(filterPumpCleaning.getId())))
    ...
    public void getFilterPumpCleaning() throws Exception {
        ...
        restFilterPumpCleaningMockMvc.perform(get("/api/filter-pump-cleanings/{id}", filterPumpCleaning.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.id").value(filterPumpCleaning.getId()))
    ...
    public void dtoEqualsVerifier() throws Exception {
        ...
        filterPumpCleaningDTO1.setId("id1");
        ...
        filterPumpCleaningDTO2.setId("id2");
        assertThat(filterPumpCleaningDTO1).isNotEqualTo(filterPumpCleaningDTO2);

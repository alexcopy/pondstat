...
import ru.gpsbox.pond.repository.OtherWorksRepository;
import ru.gpsbox.pond.repository.search.OtherWorksSearchRepository;
import ru.gpsbox.pond.service.dto.OtherWorksDTO;
import ru.gpsbox.pond.service.mapper.OtherWorksMapper;
...
public class OtherWorksResourceIntTest {
     ...
     */
    public static OtherWorks createEntity() {
    ...
    public void initTest() {
        otherWorksRepository.deleteAll();
        otherWorksSearchRepository.deleteAll();
        otherWorks = createEntity();
    }
    ...
    public void getOtherWorks() throws Exception {
        ...
        restOtherWorksMockMvc.perform(get("/api/other-works/{id}", otherWorks.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.id").value(otherWorks.getId()))

...
public class FilterPumpCleaningResource {
    ...
    @Timed
    public ResponseEntity<FilterPumpCleaningDTO> getFilterPumpCleaning(@PathVariable String id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteFilterPumpCleaning(@PathVariable String id) {

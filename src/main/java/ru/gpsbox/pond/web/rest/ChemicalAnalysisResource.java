...
public class ChemicalAnalysisResource {
    ...
    @Timed
    public ResponseEntity<ChemicalAnalysisDTO> getChemicalAnalysis(@PathVariable String id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteChemicalAnalysis(@PathVariable String id) {

...
export class ChemicalAnalysisMySuffixService {
    ...
    private resourceUrl =  SERVER_API_URL + 'api/chemical-analyses';
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/chemical-analyses';
    ...
    search(req?: any): Observable<HttpResponse<ChemicalAnalysisMySuffix[]>> {
        const options = createRequestOption(req);
        return this.http.get<ChemicalAnalysisMySuffix[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
            .map((res: HttpResponse<ChemicalAnalysisMySuffix[]>) => this.convertArrayResponse(res));
    }
